        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="mb-3 action-buttons">
                    <a href="{{ route('order.history') }}" class="btn btn-dark"><i class="fa-solid fa-arrow-left"></i> Trở lại</a>
                </div>
                ...
                <div class="action-buttons text-center">
                    <div class="d-grid gap-2 d-md-flex justify-content-md-center">
                        <a href="{{ route('order.history') }}" class="btn btn-outline-primary me-md-2">
